...
<body>
    <div class="container">
        ...
        <p>Anda menerima email ini karena kami menerima permintaan reset password untuk akun Anda di
            <strong>PREDCRYPT</strong>.
        </p>
        ...
        <div class="footer">
            <hr>
            <p>Jika Anda kesulitan mengklik tombol "Reset Password", salin dan tempel URL di bawah ini ke browser Anda:
            </p>
